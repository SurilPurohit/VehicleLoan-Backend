...
namespace VehicleLoan.Controllers
{
    ...
    public class LoginTablesController : ControllerBase
    {
        ...
        public LoginTablesController(Vehicle_LoanContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<LoginTable>> PostLoginTable(LoginTable loginTable)
        {
            ...
            {
                if (LoginTableExists(loginTable.Uname))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetLoginTable", new { id = loginTable.Uname }, loginTable);
        }
        ...
        {
            return _context.LoginTables.Any(e => e.Uname == id);
        }
    }
}
